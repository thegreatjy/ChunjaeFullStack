...
import com.practice.transaction.manager.TransactionManagerService;
...
class TransactionTemplateServiceTest {
    ...
    @Test
    @DisplayName("이체 테스트 002: send ok, receive fail ")
    void testTransfer_002(){

        service.transfer(SENDER_ID, null, AMOUNT);  // receiverId 에러
